...
def merge_selected_nodes() -> Optional[hou.Node]:
    ...
    try:
        ...
        location_choice = hou.ui.displayMessage("Where do you want to merge the nodes?",
        ...
        if location_choice == 0:                        
            name = hou.ui.readInput('Enter name for the merged node container:', 
                                  buttons=('OK', 'Cancel'),
            ...
            # Set a network box around the generated nodes for organization
            ...
            # Position and zoom to the new container
            ...
            try:
                ...
                path = hou.ui.selectNode(title='Select Merge Location',node_type_filter=hou.nodeTypeFilter.Obj)
                ...
                if not parent_node:
                    hou.ui.displayMessage(f'Invalid path: {path}',
                ...
                try:
                    ...
                    hou.ui.displayMessage(f'Cannot create nodes at this location: {path}',
                                        severity=hou.severityType.Error,
                                        title='Mass Merger')
                    return None
                    
                name = hou.ui.readInput('Enter name prefix for the merged nodes:',
                                      buttons=('OK', 'Cancel'),
                                      severity=hou.severityType.ImportantMessage,
                                      default_choice=0, close_choice=1,
                                      title='Mass Merger')[1]
                ...
                hou.ui.displayMessage(f'Error creating merge: {str(e)}',
                                    severity=hou.severityType.Error,
                                    title='Mass Merger')
                return None

    except hou.OperationFailed as e:
        hou.ui.displayMessage(f'Operation failed: {str(e)}',
                            severity=hou.severityType.Error,
                            title='Mass Merger')
        return None